// Version with CD Changer emulation
...
byte data[2] = {0x00, 0x00};    // according to autowp it sends 92 00 every 500ms

void loop()
{
currentMillis = millis();

  if(currentMillis - prevsndMillis > 500) {    // confirm if 500 is not too much
    byte sndStat = CAN0.sendMsgBuf(0x1A0, 0, 2, data);
    prevsndMillis = millis();
  }
